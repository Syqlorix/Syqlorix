...
class Processor(Iface, TProcessor):
    ...
    def process_render(self, seqid, iprot, oprot):
        ...
        result = render_result()
        try:
            result.success = self._handler.render(args.request)
...
render_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [ThriftRequest, None], None, ),  # 1
)
...
render_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ThriftResponse, None], None, ),  # 0
)
